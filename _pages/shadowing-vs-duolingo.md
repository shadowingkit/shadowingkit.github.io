...
[ShadowingKit](/){:target="_self"} picks up where Duolingo leaves off. 100+ native-speaker episodes structured by level, synchronized text highlighting, and sentence-level navigation so you can drill any phrase until it's automatic.
