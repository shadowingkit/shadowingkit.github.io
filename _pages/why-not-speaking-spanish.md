...
Shadow one short episode from your library with the text visible. Stay in sync with the speaker and match their intonation.
...
[ShadowingKit](/){:target="_self"} is built for this kind of practice. A curated library of native-speaker Spanish content, sentence-level navigation for drilling, synchronized text highlighting for guided shadowing, and auto-transcription for your own content.
