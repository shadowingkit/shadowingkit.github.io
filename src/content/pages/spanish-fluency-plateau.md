---
layout: page
title: "Breaking Through the Intermediate Spanish Plateau"
description: "Stuck at B1 Spanish? The intermediate plateau happens when passive skills outpace active production. Here's the specific method that breaks it."
permalink: /spanish-fluency-plateau/
...
1. Shadow one full-length episode at your level with the transcript visible (8 min)
2. Pick 3-5 sentences that felt difficult and repeat each 10 times (5 min)
3. Re-shadow the same passage without the transcript (2 min)
...
[ShadowingKit](/){:target="_self"} has 50+ full-length episodes built for B1-B2 learners. Latin American history, cultural icons, and everyday phenomena, all recorded by a native speaker at natural pace.
